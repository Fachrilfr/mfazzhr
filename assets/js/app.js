// Fungsi untuk mengelola pemutaran audio pada setiap card
function toggleAudio(cardNumber) {
  var playButton = document.getElementById('playButton' + cardNumber);
  var playIcon = document.getElementById('playIcon' + cardNumber);
  var audioPlayer = document.getElementById('audioPlayer' + cardNumber);

  if (audioPlayer.paused) {
      audioPlayer.play();
      playIcon.className = 'fa fa-pause'; // Ganti ikon dengan ikon berhenti (pause)
  } else {
      audioPlayer.pause();
      playIcon.className = 'fa fa-play'; // Ganti ikon dengan ikon play
  }
}
...
// Fungsi untuk mengatur progress bar sesuai dengan waktu audio
...
// Menambahkan event listener untuk setiap card
document.getElementById('audioPlayer1').addEventListener('timeupdate', function() {
  updateProgressBar(document.getElementById('audioPlayer1'), document.getElementById('progressBar1'));
});
document.getElementById('audioPlayer2').addEventListener('timeupdate', function() {
  updateProgressBar(document.getElementById('audioPlayer2'), document.getElementById('progressBar2'));
});
document.getElementById('audioPlayer3').addEventListener('timeupdate', function() {
  updateProgressBar(document.getElementById('audioPlayer3'), document.getElementById('progressBar3'));
});
document.getElementById('audioPlayer4').addEventListener('timeupdate', function() {
  updateProgressBar(document.getElementById('audioPlayer4'), document.getElementById('progressBar4'));
});

// Menambahkan event listener untuk mendeteksi saat audioPlayer selesai
document.getElementById('audioPlayer1').addEventListener('ended', function() {
  var playIcon = document.getElementById('playIcon1');
  playIcon.className = 'fa fa-play'; // Ganti ikon dengan ikon play
});
document.getElementById('audioPlayer2').addEventListener('ended', function() {
  var playIcon = document.getElementById('playIcon2');
  playIcon.className = 'fa fa-play'; // Ganti ikon dengan ikon play
});
document.getElementById('audioPlayer3').addEventListener('ended', function() {
  var playIcon = document.getElementById('playIcon3');
  playIcon.className = 'fa fa-play'; // Ganti ikon dengan ikon play
});
document.getElementById('audioPlayer4').addEventListener('ended', function() {
  var playIcon = document.getElementById('playIcon4');
  playIcon.className = 'fa fa-play'; // Ganti ikon dengan ikon play
});
